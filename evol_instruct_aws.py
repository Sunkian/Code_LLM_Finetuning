...
tgi_client = TGI(endpoint_name="huggingface-pytorch-tgi-inference-2024-05-23-05-09-46-413", region_name="us-east-1")
...
if __name__ == "__main__":
        ...
        with open('evolved_codealpaca_codellamainst70B_3gens.json', 'w') as json_file:
